<?php
	class Account {
		...
		private function insertUserDetails($un, $fn, $ln, $em, $pw) {
			...
			$encryptedPw = md5($pw);
			$profilePic = "assets/images/profile_pics/head_red.png";
			$date = date("Y-m-d:H-i-s");
			$result = mysqli_query($this->con, "INSERT INTO users VALUES('', '$un', '$fn', '$ln', '$em', '$encryptedPw', '$date', '$profilePic')");

			//if it was successful it returns true
			return $result;
		}
		...
		private function validateEmails($em, $em2) {
			...
			//check if email is in the correct format(check if it has .com part at the end)
		...
		private function validatePasswords($pw, $pw2) {
			...
			//check if it contains anything other than letters and numbers(for example !?;" etc)
